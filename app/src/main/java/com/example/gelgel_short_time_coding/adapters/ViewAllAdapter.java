...
import com.example.gelgel_short_time_coding.activities.DetailedActivity;
...
public class ViewAllAdapter extends RecyclerView.Adapter<ViewAllAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.price.setText(list.get(position).getPrice()+" Manat/kg");

        if (list.get(position).getType().equals("egg")){
            holder.price.setText(list.get(position).getPrice()+"/sany");
        }

        if (list.get(position).getType().equals("milk")){
            holder.price.setText(list.get(position).getPrice()+"/litr");
        }
